...
result_t*
RJ (struct table_t * relR, struct table_t * relS, joinconfig_t * config);

result_t*
RHO (struct table_t * relR, struct table_t * relS, joinconfig_t * config);

result_t*
RHT (relation_t * relR, relation_t * relS, joinconfig_t * config);

result_t *
join_init_run(struct table_t * relR, struct table_t * relS, JoinFunction jf, joinconfig_t * config);
