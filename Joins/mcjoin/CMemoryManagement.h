/*
	...
	Melbourne, Australia.
*/
#ifndef MCJ_CMEMORYMANAGEMENT_H
#define MCJ_CMEMORYMANAGEMENT_H
...
namespace MCJ
{
    ...
    public:
                                         ...
                                         uint32_t radixBits)
        {
            ...
            uint32_t R_idealTuples;
            uint32_t S_idealTuples;
            ...
            MCJ::CPackedPartitionMemory ppm(radixBits);
        ...
        bool optimiseForMemoryConstraint(MCJ::COptions *options)
        {
            bool result(true);
