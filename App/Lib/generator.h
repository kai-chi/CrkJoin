...
int
create_relation_from_file(relation_t *rel, char* filename, int sorted);
 ...
 */
int 
create_relation_pk(struct table_t *reln, uint64_t ntuples, int sorted);
 ...
 */
int 
create_relation_fk(struct table_t *reln, uint64_t ntuples, const int64_t maxid, int sorted);

int
create_relation_fk_sel(struct table_t *reln, uint64_t ntuples, const int64_t maxid, int sorted);
/**
 ...
 */
int
create_relation_zipf(relation_t * reln, uint64_t ntuples,
                     const int64_t maxid, const double zipfparam, int sorted);
